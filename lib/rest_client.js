...
module.exports.RestClient = function (options) {
    ...
    function apiCall(request_data, request_token = '') {
        ...
        var oauthHeaderWithCountry = Object.assign({}, oauthHeader, {'country-id': country, 'currency': currency });
        /* eslint no-undef: off*/        
        return new Promise(function (resolve, reject) {
            request({
                url: request_data.url,
                method: request_data.method,
                headers: request_token ? { 'Authorization': 'Bearer ' + request_token, 'country-id': country, 'currency': currency } : oauthHeaderWithCountry,
                json: true,
